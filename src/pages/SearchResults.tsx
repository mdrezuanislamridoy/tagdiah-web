...
export function SearchResults() {
  ...
  const { searchProducts, categories } = useStore();
        ...
        {loading ? (
          ...
          <div className="space-y-12">
            <EmptyState
              ...
              body="Check the spelling, or try a material like “linen”, “brass”, “cane” or “terracotta”."
              actionLabel="Shop everything"
              actionTo="/shop"
            />

            <div>
              <p className="eyebrow text-bark">Browse categories instead</p>
